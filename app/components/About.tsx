...
export default function About() {
    return (
        <section id="about" className="py-[94px] bg-white">
            <div className="max-w-[1220px] mx-auto px-6 sm:px-10 lg:px-12 grid lg:grid-cols-[430px_1fr] gap-12 items-start">
                ...
                <div>
                    ...
                    <div className="mt-8 flex flex-col sm:flex-row flex-wrap gap-4">
                        <a href="#portfolio" className="px-5 py-[11px] rounded-full text-white font-[600] text-[14px] text-center" style={{ background: 'linear-gradient(135deg,#5C1466,#B6178C)' }}>Explore portfolio</a>
                        <a href="#contact" className="px-5 py-[11px] rounded-full border border-[#e2b9d8] text-[#6f2a5d] font-[600] text-[14px] bg-white text-center">Work with Chinny</a>
                    </div>
